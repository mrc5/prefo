...
class TakePhotoController: UIViewController {
    ...
    lazy var addPhotoButton: UIButton = {
        ...
        button.setTitle(NSLocalizedString("TakePhotoController:AddPhotoButtonTitle",
                                          comment: "TakePhotoController:AddPhotoButtonTitle"), for: .normal)
    ...
    lazy var emptyLabel: UILabel = {
        ...
        label.text = NSLocalizedString("TakePhotoController:EmptyLabel",
                                       comment: "TakePhotoController:EmptyLabel")
...
extension TakePhotoController: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension TakePhotoController: StartViewDelegate {
    func showLoading() {
